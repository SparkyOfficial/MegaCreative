...
public class DivVarEditor extends AbstractParameterEditor {
    
    public DivVarEditor(MegaCreative plugin, Player player, CodeBlock codeBlock) {
        super(plugin, player, codeBlock, 9, "Divide Variable Editor");
    ...
    public void populateItems() {
        ...
        helpMeta.setLore(java.util.Arrays.asList(
            "§7This editor configures the Divide Variable action",
            "",
            "§eHow to use:",
            "§71. Set the variable name",
            "§72. Set the value to divide by"
        ));
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        switch (slot) {
            ...
            case 8: // Help item
                player.sendMessage("§eTip: Use this editor to configure the Divide Variable action.");
                break;
        }
    }
