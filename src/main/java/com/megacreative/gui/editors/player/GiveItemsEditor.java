...
public class GiveItemsEditor extends AbstractParameterEditor {
    
    public GiveItemsEditor(MegaCreative plugin, Player player, CodeBlock codeBlock) {
        super(plugin, player, codeBlock, 9, "Give Items Editor");
    }
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        switch (slot) {
            ...
            case 8: // Done button
                ...
                player.sendMessage("§aGive Items parameters saved!");
                break;
        }
    }
    ...
    private void openAnvilInputGUI() {
        ...
        Consumer<String> callback = (newItems) -> {
            ...
            player.sendMessage("§aItems saved!");
        ...
        new com.megacreative.gui.AnvilInputGUI(plugin, player, "Enter items (item1:amount1,item2:amount2)", callback, cancelCallback);
    }
}