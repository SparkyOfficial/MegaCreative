...
public class AddVarEditor extends AbstractParameterEditor {
    
    public AddVarEditor(MegaCreative plugin, Player player, CodeBlock codeBlock) {
        super(plugin, player, codeBlock, 9, "Add Variable Editor");
    ...
    public void populateItems() {
        ...
        helpMeta.setLore(java.util.Arrays.asList(
            "§7This editor configures the Add Variable action",
            "",
            "§eHow to use:",
            "§71. Set the variable name",
            "§72. Set the value to add"
        ));
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        switch (slot) {
            ...
            case 8: // Help item
                player.sendMessage("§eTip: Use this editor to configure the Add Variable action.");
                break;
        }
    }
