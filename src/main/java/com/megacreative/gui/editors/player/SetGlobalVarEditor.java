...
public class SetGlobalVarEditor extends AbstractParameterEditor {
    ...
    public void populateItems() {
        ...
        varMeta.setLore(java.util.Arrays.asList(
            "§7Введите имя глобальной переменной",
        ...
        valueMeta.setLore(java.util.Arrays.asList(
            "§7Введите значение глобальной переменной",
        ...
        helpMeta.setLore(java.util.Arrays.asList(
            ...
            "§7действие установки глобальной переменной",
            "",
            "§eКак использовать:",
            "§71. Укажите имя глобальной переменной",
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        switch (slot) {
            ...
            case 1: // Value slot
                ...
                new AnvilInputGUI(
                    ...
                    newValue -> {
                        ...
                        player.sendMessage("§aЗначение глобальной переменной установлено на: §f" + newValue);
                        populateItems(); // Refresh the inventory
                    },
                    () -> {} // Empty cancel callback
                );
            ...
            case 8: // Help item
                player.sendMessage("§eПодсказка: Используйте этот редактор для настройки действия установки глобальной переменной.");
                break;
        }
    }
