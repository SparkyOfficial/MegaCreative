...
public class EntityActionBlockGUI implements GUIManager.ManagedGUIInterface {
    ...
    private void loadAvailableEntityActionActions() {
        ...
        // Enhanced entity action action loading logic
        if (availableActions == null || availableActions.isEmpty()) {
            ...
            // If we still don't have actions, use default entity action actions as fallback
            if (availableActions == null || availableActions.isEmpty()) {
                // Add default entity action actions
