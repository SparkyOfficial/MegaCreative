...
/**
 * Аргумент для извлечения числового значения из параметра блока.
 */
public class NumberArgument implements Argument<NumberValue> {
    private final String parameterName;

    public NumberArgument(String parameterName) {
