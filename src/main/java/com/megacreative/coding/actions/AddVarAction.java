...
/**
 * Action to add a value to a variable
 * 
 * @author Андрій Будильников
 */
@BlockMeta(id = "addVar", displayName = "§bAdd to Variable", type = BlockType.ACTION)
public class AddVarAction implements BlockAction {
    ...
    public ExecutionResult execute(CodeBlock block, ExecutionContext context) {
        try {
            ...
            return ExecutionResult.success("Added " + value + " to variable " + name + ", result: " + result);
        } catch (Exception e) {
