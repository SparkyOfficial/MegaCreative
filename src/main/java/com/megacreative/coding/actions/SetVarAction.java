 ...
 * This action sets a variable to a specified value from container configuration.
 */
...
public ExecutionResult execute(CodeBlock block, ExecutionContext context) {
        ...
        try {
            ...
            if (variableManager != null) {
                ...
                variableManager.setVariable(resolvedVarName, resolvedValue, VariableScope.PLAYER, player.getUniqueId().toString());
                return ExecutionResult.success("Variable '" + resolvedVarName + "' set successfully");
            } else {
