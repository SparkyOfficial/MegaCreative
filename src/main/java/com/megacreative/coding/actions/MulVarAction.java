...
/**
 * Action to multiply a variable by a value
 * 
 * @author Андрій Будильников
 */
@BlockMeta(id = "mulVar", displayName = "§bMultiply Variable", type = BlockType.ACTION)
public class MulVarAction implements BlockAction {
    ...
    public ExecutionResult execute(CodeBlock block, ExecutionContext context) {
        try {
            ...
            return ExecutionResult.success("Multiplied variable " + name + " by " + value + ", result: " + result);
        } catch (Exception e) {
