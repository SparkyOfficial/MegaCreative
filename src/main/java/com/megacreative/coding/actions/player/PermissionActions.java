...
/**
 * Permission-related actions handler
 * Contains actions that affect player permissions
 */
@BlockMeta(id = "permissionActions", displayName = "§aPermission Actions", type = BlockType.ACTION)
public class PermissionActions implements BlockAction {
    
    // Action handlers map for permission actions
    ...
    /**
     * Initialize all permission action handlers
     */
