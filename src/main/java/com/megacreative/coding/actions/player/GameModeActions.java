...
/**
 * Game mode-related actions handler
 * Contains actions that change player game modes
 */
@BlockMeta(id = "gameModeActions", displayName = "§aGame Mode Actions", type = BlockType.ACTION)
public class GameModeActions implements BlockAction {
    
    // Action handlers map for game mode actions
    ...
    /**
     * Initialize all game mode action handlers
     */
