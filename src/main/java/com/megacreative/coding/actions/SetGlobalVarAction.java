...
/**
 * Action to set a global variable
 * 
 * @author Андрій Будильников
 */
@BlockMeta(id = "setGlobalVar", displayName = "§bSet Global Variable", type = BlockType.ACTION)
public class SetGlobalVarAction implements BlockAction {
    ...
    public ExecutionResult execute(CodeBlock block, ExecutionContext context) {
        try {
            ...
            // Set global variable
            context.getPlugin().getServiceRegistry().getVariableManager().setGlobalVariable(name, DataValue.of(value));
            
            return ExecutionResult.success("Set global variable " + name + " to " + value);
        } catch (Exception e) {
