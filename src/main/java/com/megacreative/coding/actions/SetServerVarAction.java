 ...
 * This action sets a server variable to a specified value from container configuration.
 */
    ...
    public ExecutionResult execute(CodeBlock block, ExecutionContext context) {
        try {
            ...
            if (variableManager != null) {
                // Use server scope
                variableManager.setVariable(resolvedVarName, resolvedValue, VariableScope.SERVER, "server");
                return ExecutionResult.success("Server variable '" + resolvedVarName + "' set successfully");
            } else {
