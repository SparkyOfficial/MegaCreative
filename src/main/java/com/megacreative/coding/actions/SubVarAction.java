...
/**
 * Action to subtract a value from a variable
 * 
 * @author Андрій Будильников
 */
@BlockMeta(id = "subVar", displayName = "§bSubtract from Variable", type = BlockType.ACTION)
public class SubVarAction implements BlockAction {
    ...
    public ExecutionResult execute(CodeBlock block, ExecutionContext context) {
        try {
            ...
            return ExecutionResult.success("Subtracted " + value + " from variable " + name + ", result: " + result);
        } catch (Exception e) {
