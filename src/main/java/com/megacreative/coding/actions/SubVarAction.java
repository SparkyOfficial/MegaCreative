 ...
 * This action subtracts a value from an existing variable from container configuration.
 */
            ...
            if (variableManager != null) {
                ...
                if (variableValue != null) {
                    try {
                        ...
                        return ExecutionResult.success("Subtracted " + subNum + " from variable '" + resolvedVarName + "', result: " + result);
                    } catch (NumberFormatException e) {
                        return ExecutionResult.error("Cannot subtract from non-numeric variable '" + resolvedVarName + "'");
                    }
                } else {
