 ...
 * This action divides an existing variable by a value.
 */
            ...
            if (variableManager != null) {
                ...
                if (variableValue != null) {
                    try {
                        ...
                        return ExecutionResult.success("Divided variable '" + varName + "' by " + divNum + ", result: " + result);
                    } catch (NumberFormatException e) {
                        return ExecutionResult.error("Cannot divide non-numeric variable '" + varName + "'");
                    }
                } else {
