...
/* 14 */     file = new File(Bukkit.getServer().getPluginManager().getPlugin("FrameLandCreative").getDataFolder(), "data.yml");
/*    */     
/* 16 */     if (!file.exists()) {
/*    */       try {
...
/* Location:              C:\Users\Богдан\Downloads\FrameLandCreative.jar!\deadpool23232\framelandcreative\Configs\DataConfig.class
